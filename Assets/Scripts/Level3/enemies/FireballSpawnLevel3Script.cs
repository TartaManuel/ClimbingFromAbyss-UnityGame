...
public class FireballSpawnLevel3Script : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (GameObject.FindGameObjectWithTag("EnemySpawner").GetComponent<EnemySpawnerScript>().isDead == true)
        {
    ...
    //aceeasi idee ca si la celalalt, doar ca e folosit de alt inamic
